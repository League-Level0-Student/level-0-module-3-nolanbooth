...
if (num > 3 && num>0) {
JOptionPane.showMessageDialog(null, "This is a cat video.");
playVideo("https://www.youtube.com/watch?v=2lz9woMsMdQ");
}
	if (num == 0) {
	JOptionPane.showMessageDialog(null, "This is a video of A Frog Sitting On a Bench Like a Human");
